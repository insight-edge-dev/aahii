  ...
  return (
    <div className="space-y-3">
      {tenders.length ? (
        tenders.map((tender) => (
          <div
            className="grid gap-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm lg:grid-cols-[1.2fr_1fr_140px_120px_92px]"
            key={tender.id}
          >
            <div>
        ...
        <div className="rounded-2xl border border-dashed border-gray-300 bg-white p-10 text-center">
          <p className="font-medium text-gray-900">No tenders yet</p>
